...
function get20s(array){
  for (let i = 0; i < array.length; ++i){
    var firstYear = array[i].years.substr(0,4);
    var secondYear = array[i].years.substr(7,4);
    if (firstYear >=1900 && secondYear <= 2000)
    {
      grabbed20sArray.push(array[i]);
    }
  }
  return grabbed20sArray;
}
...
function addArtist(array, id, name, years, genre, nationality, bio){
  ...
  console.log(addArtist(artists, 20, 'Truxton Lane', '1999 - Current', 'Musical - Grunge', 'Hispanic', 'The best gunge artist to walk this planet tbh'))
